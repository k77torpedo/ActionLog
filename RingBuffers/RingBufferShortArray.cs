namespace ActionLog {
    /// <summary>
    /// A forward 'FILO'-Ringbuffer storing <see cref="short[]"/> as data. The index '0' always is the last item added.
    /// </summary>
    public struct RingBufferShortArray {
        //Fields
