namespace ActionLog {
    /// <summary>
    /// A forward 'FILO'-Ringbuffer storing <see cref="int[]"/> as data. The index '0' always is the last item added.
    /// </summary>
    public struct RingBufferIntArray {
        //Fields
        private int[][]             _buffer;
