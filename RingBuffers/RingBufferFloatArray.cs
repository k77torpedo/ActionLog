namespace ActionLog {
    /// <summary>
    /// A forward 'FILO'-Ringbuffer storing <see cref="float[]"/> as data. The index '0' always is the last item added.
    /// </summary>
    public struct RingBufferFloatArray {
        //Fields
