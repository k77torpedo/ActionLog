namespace ActionLog {
    /// <summary>
    /// A forward 'FILO'-Ringbuffer storing <see cref="byte[]"/> as data. The index '0' always is the last item added.
    /// </summary>
    public struct RingBufferByteArray {
        //Fields
