namespace ActionLog {
    ...
    public class ActionLogFloat {
        ...
        public RingBufferFloat[,]           Actions                         { get { return _actions; } }
        public ulong                        CurrentFrame                    { get { return _frames[_frames.Head]; } }


        //Functions
        /// <summary>
        /// Creates a new instance of the <see cref="ActionLogFloat"/>-class.
        /// </summary>
        ...
        public ActionLogFloat (int pFrameCapacity, int pActionCapacity, int pActionBufferCapacity) {
            ...
            _actions = new RingBufferFloat[pFrameCapacity, pActionCapacity];
        }
        ...
        public RingBufferFloat GetActionsBuffer (int pActionId) {
        ...
        public RingBufferFloat GetActionsBuffer (ulong pFrame, int pActionId) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
        ...
        /// <returns>True if the frame was found, otherwise false.</returns>
        public bool TryGetActionsBuffer (ulong pFrame, int pActionId, out RingBufferFloat pBuffer) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
