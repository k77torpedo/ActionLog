namespace ActionLog {
    ...
    public class ActionLogInt {
        ...
        public RingBufferInt[,]             Actions                         { get { return _actions; } }
        public ulong                        CurrentFrame                    { get { return _frames[_frames.Head]; } }


        //Functions
        /// <summary>
        /// Creates a new instance of the <see cref="ActionLogInt"/>-class.
        /// </summary>
        ...
        public ActionLogInt (int pFrameCapacity, int pActionCapacity, int pActionBufferCapacity) {
            ...
            _actions = new RingBufferInt[pFrameCapacity, pActionCapacity];
        }
        ...
        public RingBufferInt GetActionsBuffer (int pActionId) {
        ...
        public RingBufferInt GetActionsBuffer (ulong pFrame, int pActionId) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
        ...
        public bool TryGetActionsBuffer (ulong pFrame, int pActionId, out RingBufferInt pBuffer) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
