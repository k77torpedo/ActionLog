namespace ActionLog {
    ...
    public class ActionLogIntArray {
        ...
        public RingBufferIntArray[,]        Actions                         { get { return _actions; } }
        public ulong                        CurrentFrame                    { get { return _frames[_frames.Head]; } }


        //Functions
        /// <summary>
        /// Creates a new instance of the <see cref="ActionLogIntArray"/>-class.
        /// </summary>
        ...
        public ActionLogIntArray (int pFrameCapacity, int pActionCapacity, int pActionBufferCapacity) {
            ...
            _actions = new RingBufferIntArray[pFrameCapacity, pActionCapacity];
        }
        ...
        public void Add (ulong pFrame, int pActionId, int[] pActionData) {
        ...
        /// <param name="pActionId">The id of the action.</param>
        /// <param name="pActionData">The data of the action.</param>
        public void AddAction (int pActionId, int[] pActionData) {
            _actions[_frames.Head, pActionId].Add(pActionData);
        }
        ...
        /// <param name="pActionId">The id of the action.</param>
        /// <param name="pActionData">The data of the action.</param>
        public void AddAction (ulong pFrame, int pActionId, int[] pActionData) {
        ...
        public RingBufferIntArray GetActionsBuffer (int pActionId) {
        ...
        public RingBufferIntArray GetActionsBuffer (ulong pFrame, int pActionId) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
        ...
        /// <returns>True if the frame was found, otherwise false.</returns>
        public bool TryGetActionsBuffer (ulong pFrame, int pActionId, out RingBufferIntArray pBuffer) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
