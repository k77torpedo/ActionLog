namespace ActionLog {
    ...
    public class ActionLogShortArray {
        ...
        public RingBufferShortArray[,]      Actions                         { get { return _actions; } }
        public ulong                        CurrentFrame                    { get { return _frames[_frames.Head]; } }


        //Functions
        /// <summary>
        /// Creates a new instance of the <see cref="ActionLogShortArray"/>-class.
        /// </summary>
        ...
        public ActionLogShortArray (int pFrameCapacity, int pActionCapacity, int pActionBufferCapacity) {
            ...
            _actions = new RingBufferShortArray[pFrameCapacity, pActionCapacity];
        }
        ...
        public void Add (ulong pFrame, int pActionId, short[] pActionData) {
        ...
        /// <param name="pActionId">The id of the action.</param>
        /// <param name="pActionData">The data of the action.</param>
        public void AddAction (int pActionId, short[] pActionData) {
            _actions[_frames.Head, pActionId].Add(pActionData);
        }
        ...
        /// <param name="pActionId">The id of the action.</param>
        /// <param name="pActionData">The data of the action.</param>
        public void AddAction (ulong pFrame, int pActionId, short[] pActionData) {
        ...
        public RingBufferShortArray GetActionsBuffer (int pActionId) {
        ...
        public RingBufferShortArray GetActionsBuffer (ulong pFrame, int pActionId) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
        ...
        public bool TryGetActionsBuffer (ulong pFrame, int pActionId, out RingBufferShortArray pBuffer) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
