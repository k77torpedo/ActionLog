namespace ActionLog {
    ...
    public class ActionLogShort {
        ...
        public RingBufferShort[,]           Actions                         { get { return _actions; } }
        public ulong                        CurrentFrame                    { get { return _frames[_frames.Head]; } }


        //Functions
        /// <summary>
        /// Creates a new instance of the <see cref="ActionLogShort"/>-class.
        /// </summary>
        ...
        public ActionLogShort (int pFrameCapacity, int pActionCapacity, int pActionBufferCapacity) {
            ...
            _actions = new RingBufferShort[pFrameCapacity, pActionCapacity];
        }
        ...
        public RingBufferShort GetActionsBuffer (int pActionId) {
        ...
        public RingBufferShort GetActionsBuffer (ulong pFrame, int pActionId) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
        ...
        /// <returns>True if the frame was found, otherwise false.</returns>
        public bool TryGetActionsBuffer (ulong pFrame, int pActionId, out RingBufferShort pBuffer) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
