namespace ActionLog {
    ...
    public class ActionLogFloatArray {
        ...
        public RingBufferFloatArray[,]      Actions                         { get { return _actions; } }
        public ulong                        CurrentFrame                    { get { return _frames[_frames.Head]; } }


        //Functions
        /// <summary>
        /// Creates a new instance of the <see cref="ActionLogFloatArray"/>-class.
        /// </summary>
        ...
        public ActionLogFloatArray (int pFrameCapacity, int pActionCapacity, int pActionBufferCapacity) {
            ...
            _actions = new RingBufferFloatArray[pFrameCapacity, pActionCapacity];
        }
        ...
        public void Add (ulong pFrame, int pActionId, float[] pActionData) {
        ...
        /// <param name="pActionId">The id of the action.</param>
        /// <param name="pActionData">The data of the action.</param>
        public void AddAction (int pActionId, float[] pActionData) {
            _actions[_frames.Head, pActionId].Add(pActionData);
        }
        ...
        /// <param name="pActionId">The id of the action.</param>
        /// <param name="pActionData">The data of the action.</param>
        public void AddAction (ulong pFrame, int pActionId, float[] pActionData) {
        ...
        public RingBufferFloatArray GetActionsBuffer (int pActionId) {
        ...
        public RingBufferFloatArray GetActionsBuffer (ulong pFrame, int pActionId) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
        ...
        public bool TryGetActionsBuffer (ulong pFrame, int pActionId, out RingBufferFloatArray pBuffer) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
