namespace ActionLog {
    ...
    public class ActionLogByte {
        ...
        public RingBufferByte[,]            Actions                         { get { return _actions; } }
        public ulong                        CurrentFrame                    { get { return _frames[_frames.Head]; } }


        //Functions
        /// <summary>
        /// Creates a new instance of the <see cref="ActionLogByte"/>-class.
        /// </summary>
        ...
        public ActionLogByte (int pFrameCapacity, int pActionCapacity, int pActionBufferCapacity) {
            ...
            _actions = new RingBufferByte[pFrameCapacity, pActionCapacity];
        }
        ...
        public RingBufferByte GetActionsBuffer (int pActionId) {
        ...
        public RingBufferByte GetActionsBuffer (ulong pFrame, int pActionId) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
        ...
        public bool TryGetActionsBuffer (ulong pFrame, int pActionId, out RingBufferByte pBuffer) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
