namespace ActionLog {
    ...
    public class ActionLogStringArray {
        ...
        public RingBufferStringArray[,]     Actions                         { get { return _actions; } }
        public ulong                        CurrentFrame                    { get { return _frames[_frames.Head]; } }


        //Functions
        /// <summary>
        /// Creates a new instance of the <see cref="ActionLogStringArray"/>-class.
        /// </summary>
        ...
        public ActionLogStringArray (int pFrameCapacity, int pActionCapacity, int pActionBufferCapacity) {
            ...
            _actions = new RingBufferStringArray[pFrameCapacity, pActionCapacity];
        }
        ...
        public RingBufferStringArray GetActionsBuffer (int pActionId) {
        ...
        public RingBufferStringArray GetActionsBuffer (ulong pFrame, int pActionId) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
        ...
        /// <returns>True if the frame was found, otherwise false.</returns>
        public bool TryGetActionsBuffer (ulong pFrame, int pActionId, out RingBufferStringArray pBuffer) {
            for (int i = 0; i < _frames.Count; i++) {
                if (_frames[i] == pFrame) {
